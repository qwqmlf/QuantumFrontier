            ...
            {/* <Mathjax.Provider> */}
                ...
                <div className={classes.paragraph}>
                    ...
                    <p>
                        ...
                        {/* <span class="math display">\[\begin{aligned}\vert\psi_t\rangle = (U_{walk})^t\vert\psi_{0}\rangle\end{aligned}\]</span>  */}
                        となり、連続時間量子ウォークの場合 
                        {/* <span class="math display">\[\begin{aligned} \vert\psi_t\rangle = U_{walk}(\theta_t)\vert\psi_{0}\rangle\end{aligned}\]</span> というようになります。 */}
                        ここで、
                        {/* <span class="math inline">\(\vert\psi_t\rangle\)</span> */}
                        ...
                        {/* <span class="math inline">\(t\)</span> */}
                        に対応したパラメータ、
                        {/* <span class="math inline">\(\vert\psi_0\rangle\)</span>が、量子ウォーカーが最初にどのような状態にあるのかという初期状態を表しています。ここで、離散時間と連続時間の違いとしては、離散時間量子ウォークの場合は、1ステップ毎にオペレータをかけ続けることで時間発展をシミュレーションしているのに対し、連続時間量子ウォークの場合は、オペレータにおけるあるパラメータ<span class="math inline">\(\theta_t\)</span> */}
                ...
                <div className={classes.paragraph}>
                    ...
                    <p>
                        ...
                        {/* <span class="math inline">\(t\)</span> */}
                        における量子ウォーカーは 
                        {/* <span class="math display">\[\begin{aligned} \vert\psi_t\rangle = (SC)^t|\psi_{0}\rangle\end{aligned}\]</span>  */}
                        のように表すことができます。
                        先ほどの
                        {/* <span class="math inline">\(U_{walk}\)</span> */}
